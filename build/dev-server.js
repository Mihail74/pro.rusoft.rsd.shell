...
if (!process.env.NODE_ENV) {
  process.env.NODE_ENV = JSON.parse(buildConfig.dev.env.NODE_ENV)
}
...
var staticPath = path.posix.join(buildConfig.dev.assetsPublicPath, buildConfig.dev.assetsSubDirectory)
